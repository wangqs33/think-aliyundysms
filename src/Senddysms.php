...
namespace qingsong\aliyundysms;
...
class Senddysms {
    ...
    private static $product = "Dysmsapi";
    private static $domain = "dysmsapi.aliyuncs.com";
    private static $region = "cn-hangzhou";
    private static $endPointName = "cn-hangzhou";
     ...
     * @return stdClass
     */
    public static function sendSms($phone, $templateid, $templateParam, $sign = '学到做到') {
